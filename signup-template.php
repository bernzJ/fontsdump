                ...
                <div class="col-xl-4 col-lg-6 col-md-6 form-wrapper cariera-scroll">
                    <div class="content">
                        ...
                        <div class="signin-wrapper">
                            ...
                            <?php echo do_shortcode('[elementor-template id="6851"]'); //Add register form ?>

                            <div class="bottom-links">
                                <a href="#" class="signUpClick"><i class="fas fa-user"></i><?php esc_html_e( 'Already registered?', 'cariera' ); ?></a>
                        ...
                        <div class="signup-wrapper">
                            ...
                            <?php echo do_shortcode('[elementor-template id="6856"]'); //Add registration form ?>

                            <div class="bottom-links">
                                <a href="#" class="signInClick"><i class="fas fa-user"></i><?php esc_html_e( 'Don\'t have an account?', 'cariera' ); ?></a>
                                <a href="#" class="forgetPasswordClick"><i class="fas fa-lock"></i><?php esc_html_e( 'Forgot Password?', 'cariera' ); ?></a>
                            </div>
