...
<form id="cariera_login" method="post">
  ...
  <div class="form-group">
    <label for="username"><?php esc_html_e('Email', 'cariera'); ?></label>
    <input type="text" class="form-control" id="username" name="username" placeholder="<?php esc_html_e('Email', 'cariera'); ?>" />
  </div>
